...
#### Step 6.2: 캘린더 도구 구현  
**목표**: Notion 캘린더 데이터베이스를 관리하는 MCP 도구
...
**목표**: Notion 할일 데이터베이스를 관리하는 MCP 도구  
...
**목표**: 실제 Notion 데이터베이스와 연동 테스트

**계획된 작업:**
- [ ] 자연어 요청 → Notion 작업 파이프라인 테스트
- [ ] 성능 최적화 및 오류 처리
- [ ] 사용자 시나리오 기반 통합 테스트
- [ ] 문서화 및 사용 가이드

### Phase 7: Apple/macOS 통합 (우선순위 2)
